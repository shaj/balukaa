...
class TestACardView(TestCase):
    def setUp(self):
        ...
        self.user = LedgerUser.objects.create_user(
            username="user", password="useer123456", email="user@user.com"
        )
        self.admin = LedgerUser.objects.create_superuser(
            username="admin", password="admin123456", email="admin@user.com"
        )
    ...
    def test_context_without_params(self):
        ...
        self.assertDictEqual(
            response.context["begin_balance"],
            {
    ...
    def test_context_with_dates(self):
        ...
        response = self.client.get(
            reverse("acard", args=[self.accounts["50"].id]),
            {"from": "20210117", "to": "20210311"},
        )
